...
const mockClasses: ClassData[] = [
  ...
  },
  {
    id: 'cls-006',
    name: 'Invoice',
    description: 'A document issued by a seller to a buyer relating to a sale transaction.',
    properties: {
      attributes: 14,
      relationships: 6,
      instances: 9500000,
  ...
  },
  {
    id: 'cls-007',
    name: 'Shipment',
    description: 'A consignment of goods sent or transported to a destination.',
    properties: {
      attributes: 16,
      relationships: 5,
      instances: 7200000,
  ...
  },
  {
    id: 'cls-008',
    name: 'Supplier',
    description: 'An entity that provides products or services to the organization.',
    properties: {
      attributes: 11,
      relationships: 7,
      instances: 45000,
    ...
    metadata: {
      createdAt: '2022-04-20T13:00:00Z',
      updatedAt: '2024-09-15T16:20:00Z',
      owner: 'Data Architecture',
      tags: ['core-entity', 'supply-chain'],
    },
  },
];
...
const mockBusinessConcepts: BusinessConceptData[] = [
  ...
  },
  {
    ...
    description: 'The average monetary value of each order placed by customers.',
    properties: {
    ...
    metadata: {
      ...
      tags: ['kpi', 'sales', 'revenue'],
    },
  },
  {
    id: 'bc-008',
    name: 'Return on Investment',
    description: 'A measure of the profitability of an investment relative to its cost.',
    properties: {
    ...
    metadata: {
      createdAt: '2022-08-15T09:30:00Z',
      updatedAt: '2024-11-10T11:00:00Z',
      owner: 'Finance',
      tags: ['kpi', 'financial', 'investment'],
    },
  },
  {
    id: 'bc-009',
    ...
    metadata: {
      ...
      owner: 'Marketing',
      tags: ['kpi', 'marketing', 'acquisition'],
    },
  },
  {
    id: 'bc-010',
    name: 'Employee Productivity',
    description: 'A measure of the output produced per employee over a given time period.',
    properties: {
  ...
  'cls-006': [
    {
      ...
      description: 'All invoice documents and related metadata.',
      classId: 'cls-006',
      properties: {
        format: 'Parquet',
        size: '8.5 GB',
        recordCount: 9500000,
        lastRefreshed: '2024-11-29T07:00:00Z',
        quality: '99.2%',
      },
      metadata: {
        createdAt: '2022-05-15T10:00:00Z',
        ...
        owner: 'Finance Operations',
        tags: ['invoice', 'financial', 'documents'],
      },
    },
  ],
  'cls-007': [
    {
      ...
      description: 'Real-time shipment tracking and delivery data.',
      classId: 'cls-007',
      properties: {
        format: 'Delta Lake',
        size: '6.2 GB',
        recordCount: 7200000,
        lastRefreshed: '2024-11-29T11:00:00Z',
        quality: '98.5%',
      },
      metadata: {
        createdAt: '2022-06-01T09:00:00Z',
        ...
        tags: ['shipment', 'tracking', 'logistics'],
      },
    },
  ],
  'cls-008': [
    {
      ...
      description: 'Master data for all registered suppliers.',
      classId: 'cls-008',
      properties: {
        format: 'JSON',
        size: '120 MB',
        recordCount: 45000,
        lastRefreshed: '2024-11-28T16:00:00Z',
        quality: '97.5%',
      },
      metadata: {
        createdAt: '2022-04-20T13:00:00Z',
        ...
        owner: 'Procurement',
        tags: ['supplier', 'master-data', 'procurement'],
      },
    },
  ],
};
...
const mockAttributes: Record<string, AttributeData[]> = {
  ...
  'cls-006': [
    ...
    },
    {
      ...
      properties: {
        ...
        isForeignKey: false,
        defaultValue: '0.00',
        constraints: ['NOT NULL', 'CHECK (invoice_amount >= 0)'],
      },
      metadata: {
        createdAt: '2022-05-15T10:00:00Z',
        updatedAt: '2024-11-05T11:30:00Z',
  ...
  'cls-008': [
    ...
    },
    {
      id: 'attr-supp-002',
      name: 'supplier_name',
      description: 'Official name of the supplier.',
      classId: 'cls-008',
      properties: {
        dataType: 'VARCHAR(200)',
        nullable: false,
